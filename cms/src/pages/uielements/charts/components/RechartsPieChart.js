...
const chartsSettings = {
	donut: {
		data: [
			{ name: "Tiếp nhận", key: 0, value: 0, color: '#FFC405' },
			{ name: 'Đang vận chuyển', key: 1, value: 0, color: '#4D53E0' },
			{ name: "Đã bàn giao", key: 2, value: 0, color: '#43BC13' },
			{ name: 'Đã hủy', key: 3, value: 0, color: '#FF5668' },
		],
	}
};
